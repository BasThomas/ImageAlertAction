...
public extension UIAlertAction {
    ...
    /// This parameter must not be nil, except in a tvOS app where a nil title may be used with [UIAlertAction.Style.cancel](https://developer.apple.com/documentation/uikit/uialertaction/style/cancel).
    ...
    /// For a list of possible values, see the constants in [UIAlertAction.Style](https://developer.apple.com/documentation/uikit/uialertaction/style).
    ...
    public convenience init(title: String? = nil, image: UIImage, style: UIAlertAction.Style, handler: ((UIAlertAction) -> Void)? = nil) {
